...
/**
 * {@link DiggingEnchantment}に対する操作を行うクラス<br>
 * Enchantmentを継承することで、メソッドの上書きを行う
 * Created by A.K. on 2022/09/22.
 */
@Mixin(DiggingEnchantment.class)
public abstract class MixinDiggingEnchantment extends Enchantment {

  protected MixinDiggingEnchantment(Rarity rarity,
  ...
  public int getMaxLevel() {
    return ConfigUtils.COMMON.diggingEnchantmentMaxLevel;
  }
